...
export default function AboutStats() {
  ...
  return (
    <div className="w-full bg-[#EBF2F7]/50 border border-gray-200/80 rounded-lg py-8 px-6 sm:px-10 mb-12 sm:mb-16 shadow-xs">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 divide-y md:divide-y-0 md:divide-x divide-gray-200/70 text-center">
        {stats.map((stat, idx) => (
          ...
          >
            <span className="text-xl sm:text-2xl lg:text-3xl font-black text-brand-primary-800 tracking-tight">
              {stat.value}
            </span>
